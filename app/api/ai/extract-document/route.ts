...
const ORDER_FORM_ALLOWED_FIELDS = new Set([
  ...
  // ── VLU Phase 2 fields ──
  "ceap_classification",
  "relevant_vascular_history",
  "wound_surface_area_cm2",
  "periwound_status",
  "signs_active_infection",
  "compression_type_class",
  "initial_wound_area_cm2",
  "current_wound_area_cm2",
  "venous_studies_findings",
  "arterial_supply_adequate_yn",
  "arterial_supply_basis",
  "skin_substitute_product",
  "skin_substitute_hcpcs",
  "anticipated_applications_count",
  "application_interval",
  "clinical_rationale_text",
  // ── DFU Phase 2 fields ──
  "referring_provider",
  "diabetes_type",
  "wagner_grade",
  "ut_stage_grade",
  "osteomyelitis_status",
  "osteomyelitis_basis",
  "depth_structures_exposed",
  "tissue_quality_breakdown",
  "infection_status_category",
  "infection_cultures",
  "current_antibiotics",
  "tcpo2_value",
  "pedal_pulses",
  "vascular_surgery_referral",
  "vascular_surgery_details",
  "perfusion_summary",
  "measured_response",
  "dfu_procedures",
