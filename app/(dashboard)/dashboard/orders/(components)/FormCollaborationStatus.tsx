...
export function FormCollaborationStatus({
  ...
  return (
    <>
      ...
      {/* Conflict banner — sticky just under the FormActionBar (which is
          `top-0 z-20`) so the warning + Reload button stay visible while
          the user scrolls through long forms. White underlay so the banner
          doesn't bleed against the form when pinned. */}
      {conflict && (
        <div className="sticky top-12 z-10 bg-white pt-2 pb-2">
