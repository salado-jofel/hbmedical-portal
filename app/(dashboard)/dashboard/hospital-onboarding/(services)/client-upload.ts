...
import {
  prepareHospitalOnboardingUpload,
  completeHospitalOnboardingUpload,
} from "./actions";

export async function uploadHospitalOnboardingMaterial(
  formData: FormData,
): Promise<void> {
  ...
  await uploadFileDirectToSupabase({
    ...
    completeUpload: completeHospitalOnboardingUpload,
  });
}
